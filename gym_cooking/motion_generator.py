...
class MotionGenerator:
    ...
    def set_environment_state(self, environment_state, ignore_agents_as_obstacles=False):
        ...
        #print("Agent Pos (set env state):", self.agent_position)
        self.create_graph()
    ...
    def create_graph(self):
        ...
        # create feature map with 'free' fields. Each free field is represented by a 1,  fields represented by a 0.
    ...
    def get_free_neighbors(self, position):
        ...
        for neighbor in possible_neighbors:
            if all([n < g for n, g in zip(neighbor, self.env_state_free_fields.shape)]) and self.env_state_free_fields[neighbor]:
